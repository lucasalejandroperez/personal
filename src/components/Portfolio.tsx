...
const Portfolio = () => {
  const { product, about, portfolio } = config;
  ...
  return (
    <section className={`bg-background py-8`} id="portfolio">
      <div className={`container max-w-5xl mx-auto m-8`}>
        ...
        <Divider />
        <div className={`flex flex-wrap mb-8 border rounded`}>
        ...
        <div
          className={`flex flex-wrap flex-col-reverse sm:flex-row mb-8 border rounded`}
        >
          <div className={`w-full sm:w-1/2 p-6  opacity-100 hover:opacity-80`}>
            <Tilt>
              <img
          ...
          <div className={`w-full sm:w-1/2 p-6`}>
            <div className={`align-middle`}>
              ...
              <div>
                <p className={`text-gray-600 mb-8`}>React application</p>
                <p>
                  Gamer Cards is an NFT Marketplace, where you can buy cards of
        ...
        <div
          className={`flex flex-wrap flex-col-reverse sm:flex-row border rounded`}
        >
          <div className={`w-full sm:w-1/2 p-6 opacity-100 hover:opacity-80`}>
            <Tilt>
              <img
